...
= 1.4.4 =
Added translation template (POT). No functional changes. Existing shortcodes and classic widget settings continue to work.

== Changelog ==

= 1.4.4 =
* Added translation template (POT) and Domain Path header.
